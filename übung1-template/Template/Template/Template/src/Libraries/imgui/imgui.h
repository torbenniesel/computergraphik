...
namespace ImGui
{
    ...
    IMGUI_API void          ShowDemoWindow(bool* p_open = NULL);        // create demo/test window (previously called ShowPluginWindow). demonstrate most ImGui features. call this to learn about the library! try to make it always available in your application!
...
enum ImGuiFocusedFlags_
{
    ...
    ImGuiFocusedFlags_RootWindow                    = 1 << 1,   // IsWindowFocused(): Plugin from root window (top most parent of the current hierarchy)
...
enum ImGuiHoveredFlags_
{
    ...
    ImGuiHoveredFlags_RootWindow                    = 1 << 1,   // IsWindowHovered() only: Plugin from root window (top most parent of the current hierarchy)
...
namespace ImGui
{
    ...
    static inline void  ShowPluginWindow()                      { return ShowDemoWindow(); }
